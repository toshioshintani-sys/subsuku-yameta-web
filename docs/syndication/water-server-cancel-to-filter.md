...
## ウォーターサーバーのコストを正確に把握する

水代・サーバーレンタル代・電気代を合わせると、月3,000〜4,000円、年にすると4〜5万円が一般的な水準だ。すぐ冷水・お湯が出る便利さはあるが、使っても使わなくても発生する固定費でもある。

## 卒業→入学：浄水ポットという買い切り

水道水をろ過する浄水ポット（ピッチャー型）やカートリッジ式に変えると、かかるのは本体の買い切り代＋カートリッジ代だけになる。

本体とカートリッジの最新価格は、Amazonで浄水ポットを見る（PR）、または楽天市場で見る（PR）で確認できる。

## 年いくら浮くか

> 浮く額 = サーバー年額 − （ポット本体 + 年間カートリッジ代）

例：サーバー年48,000円 −（ポット約3,000円 + カートリッジ年6,000円）≈ 年39,000円の節約。初年度から大きく浮く計算になる。
...
これらに当てはまるなら、サーバーを続けるのが正解だ。浄水ポットには「冷水やお湯がすぐ出ない」「ろ過に少し時間がかかる」「容量が限られる」といった弱点もある。
...
目安は「浮く額 = サーバー年額 −（ポット本体 + 年間カートリッジ代）」で計算できます。例えばサーバー年48,000円 −（ポット約3,000円 + カートリッジ年6,000円）≈ 年39,000円の節約。初年度から大きく浮く計算です。

**Q. ウォーターサーバーのコストはどれくらい？**

水代・サーバーレンタル代・電気代を合わせると、月3,000〜4,000円、年にすると4〜5万円が一般的な水準です。すぐ冷水・お湯が出る便利さはありますが、使っても使わなくても発生する固定費でもあります。

**Q. ウォーターサーバーを続けた方がいい（向く）人は？**

次に当てはまる人はサーバーを続けるのが正解です。(1)乳児のミルク用に、すぐお湯が必要、(2)重い水を運ぶのが負担・買い物の頻度を減らしたい、(3)災害用の備蓄水を兼ねたい、(4)料理や炭酸用に大量の水を使う、(5)賃貸で蛇口に浄水器を取り付けられない。なお浄水ポットには「冷水やお湯がすぐ出ない」「ろ過に少し時間がかかる」「容量が限られる」といった弱点もあります。

**Q. 解約するときの注意点は？**

ウォーターサーバーは「最低利用期間内に解約すると解約金」「サーバー返却時の送料が自己負担」になることが多いです。まず契約書で最低利用期間と返却条件を確認してから手続きしてください。
