 ...
 *  2026-07-31: TTS 161.72 / TTB 159.72 → TTM 160.72
 *  ⚠️ 同じページに「外貨現金両替相場」（この日は 163.52 / 157.72）が並んでいる。**別物**。
 *     必ず上段の対顧客電信相場（US Dollar / 米ドル / USD の行）の TTS・TTB を使うこと。 */
export const USD_JPY = 160.72;
/** ページに書かれていた「相場日」。土日に読むと最終営業日になる */
export const USD_JPY_AS_OF = '2026-07-31';
