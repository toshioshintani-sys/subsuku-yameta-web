 ...
 *  2026-08-17: TTS 160.11 / TTB 158.11 → TTM 159.11
 *  ⚠️ 同じページに「外貨現金両替相場」（この日は 161.91 / 156.11）が並んでいる。**別物**。
 *     必ず上段の対顧客電信相場（US Dollar / 米ドル / USD の行）の TTS・TTB を使うこと。 */
export const USD_JPY = 159.11;
/** ページに書かれていた「相場日」。土日に読むと最終営業日になる */
export const USD_JPY_AS_OF = '2026-08-17';
/** 実際にページを読んだ日。AS_OF と違えば「最終営業日の値」という注釈が出る */
export const USD_JPY_READ_ON = '2026-08-17';
