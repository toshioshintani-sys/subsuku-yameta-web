 ...
 *  2026-08-14: TTS 160.42 / TTB 158.42 → TTM 159.42
 *  ⚠️ 同じページに「外貨現金両替相場」（この日は 162.22 / 156.42）が並んでいる。**別物**。
 *     必ず上段の対顧客電信相場（US Dollar / 米ドル / USD の行）の TTS・TTB を使うこと。 */
export const USD_JPY = 159.42;
/** ページに書かれていた「相場日」。土日に読むと最終営業日になる */
export const USD_JPY_AS_OF = '2026-08-14';
/** 実際にページを読んだ日。AS_OF と違えば「最終営業日の値」という注釈が出る */
export const USD_JPY_READ_ON = '2026-08-16';
